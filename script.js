document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      aboutMe: 'Sobre mí',
      homeTitle: 'Hola, soy <span>Fabio Sanchez</span>',
      homeRole: 'Gerente <span>General</span>',
      homeDesc: 'En Sistemas Litográficos tenemos las soluciones que necesitas para tus proyectos',
      aboutTitle: 'Gerente <span>General</span> con 25 años de experiencia',
      aboutDesc: '25 años liderando procesos de impresión y producción gráfica con enfoque en calidad, innovación y cumplimiento.',
      empresaTitle: 'Nuestra <span>Empresa</span>',
      empresaNosotros: 'Nosotros',
      empresaNosotrosDesc: 'Somos una empresa con 25 años transformando ideas en impresiones de alto impacto, con diseños enfocados en la innovación, calidad y usando siempre la tecnología de vanguardia.',
    ...
    en: {
      ...
      aboutMe: 'About me',
      homeTitle: 'Hi, I\'m <span>Fabio Sanchez</span>',
      homeRole: 'General <span>Manager</span>',
      homeDesc: 'At Sistemas Litográficos we have the solutions you need for your projects',
      aboutTitle: 'General <span>Manager</span> with 25 years of experience',
      aboutDesc: 'Over 25 years leading printing and graphic production processes with a focus on quality, innovation and fulfillment.',
      empresaTitle: 'Our <span>Company</span>',
      empresaNosotros: 'About us',
      empresaNosotrosDesc: 'We are a company with 25 years transforming ideas into high-impact prints, with designs focused on innovation, quality, and always using cutting-edge technology.',
  ...
  // ===== CONTACT FORM =====
  const WHATSAPP_NUMBER = '573165281355'; // Fabio Sánchez (+57 316 528 1355)
  const ASESOR_NAME = 'Fabio Sánchez';
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (APPS_SCRIPT_URL.startsWith('http')) {
        const payload = new URLSearchParams({
          ...
          message: message,
          mensaje: message,
          origen: 'landing-fabio-sanchez-2',
          page: location.href,
